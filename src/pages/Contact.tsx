          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600">
                  {t('يمكنكم التواصل معنا عبر الوسائل التالية', 'You can contact us through the following methods')}
                </p>
              </div>
...
<section className="py-20 bg-white">
  <div className="container mx-auto px-4">
    ...
    >
      {/* Google Maps Embed */}
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.2209!2d31.2919!3d30.0090!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583e2e4fffb4c7%3A0x123456789!2sAl%20Mokattam%2C%20Cairo!5e0!3m2!1sen!2seg!4v1693300000000!5m2!1sen!2seg"
        width="100%"
        height="100%"
        style={{ border: 0 }}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('الأسئلة الشائعة', 'Frequently Asked Questions')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
              >
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t(faq.question_ar, faq.question_en)}</h3>
                <p className="text-gray-600 leading-relaxed">{t(faq.answer_ar, faq.answer_en)}</p>
              </motion.div>
            ))}
          </div>
        </div>
